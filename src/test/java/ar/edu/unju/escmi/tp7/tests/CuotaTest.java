...
public class CuotaTest {
    ...
    void testListaCuotasNoNulaAlGenerarCuotas() {
        // 1. Preparar
    // Se crea el crédito con el monto correspondiente a los detalles Ahora30
